...
if (x3 === 8 || x4 === 8 || x3 + x4 === 8 || x3 - x4 === 8 || x4 - x3 === 8) {
...
console.log('Importo totale:', totale);
...
let totale2 = totalShoppingCart2 - sconto;

if (totalShoppingCart2 < 50) {
  totale2 += spedizione2
}

console.log('Importo totale:', totale2);
...
if (es1 >= es2) {
  ...
  if (es3 >= es2) {
    ...
    if (es3 >= es1) {
      console.log(es2, es3, es1);
    } else {
      console.log(es2, es1, es3);
    }
  }
}
/* SCRIVI QUI LA TUA RISPOSTA */
...
*/
let esercizio8 = 'Terra';

if (typeof esercizio8 === 'numero') {
